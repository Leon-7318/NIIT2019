...
<div class="row">
    <form id="newsContent">
        <table>
        <c:forEach var="i" begin="0" end="${video.res.size()-1}" step="3">
            <tr>                    
                <td>
                    <div class="entity_wrapper">
                          <div class="entity_title">
                            <h1><a href="${pageContext.request.contextPath}/video/showVideo?id=${video.getRes(i).id}">${video.getRes(i).title}</a></h1>
                        </div>
                        <div class="entity_thumb">
                            <a href="${pageContext.request.contextPath}/video/showVideo?id=${video.getRes(i).id}v">
                                <img class="img-responsive" src="${video.getRes(i).image}" width="400" height="250" alt="feature-top"/>
                            </a>
                        </div>
                        <div class="entity_content">
                            <a href="${pageContext.request.contextPath}/video/showVideo?id=${video.getRes(i).id}"><p>${video.getRes(i).sketch}</p></a>
                        </div>
                        <div class="entity_meta">${video.getRes(i).date} , by: ${video.getRes(i).author}</div>
                    </div>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
                    <div class="entity_wrapper">
                          <div class="entity_title">
                            <h1><a href="${pageContext.request.contextPath}/video/showVideo?id=${video.getRes(i+1).id}">${video.getRes(i+1).title}</a></h1>
                        </div>
                        <div class="entity_thumb">
                            <a href="${pageContext.request.contextPath}/video/showVideo?id=${video.getRes(i+1).id}">
                                <img class="img-responsive" src="${video.getRes(i+1).image}" width="400" height="250" alt="feature-top"/>
                            </a>
                        </div>
                        <div class="entity_content">
                            <a href="${pageContext.request.contextPath}/video/showVideo?id=${video.getRes(i+1).id}"><p>${video.getRes(i+1).sketch}</p></a>
                        </div>
                        <div class="entity_meta">${video.getRes(i+1).date} , by: ${video.getRes(i+1).author}</div>
                    </div>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
                    <div class="entity_wrapper">
                          <div class="entity_title">
                            <h1><a href="${pageContext.request.contextPath}/video/showVideo?id=${video.getRes(i+2).id}">${video.getRes(i+2).title}</a></h1>
                        </div>
                        <div class="entity_thumb">
                            <a href="${pageContext.request.contextPath}/video/showVideo?id=${video.getRes(i+2).id}">
                                <img class="img-responsive" src="${video.getRes(i+2).image}" width="400" height="250" alt="feature-top"/>
                            </a>
                        </div>
                        <div class="entity_content">
                            <a href="${pageContext.request.contextPath}/video/showVideo?id=${video.getRes(i+2).id}"><p>${video.getRes(i+2).sketch}</p></a>
                        </div>
                        <div class="entity_meta">${video.getRes(i+2).date} , by: ${video.getRes(i+2).author}</div>
                    </div>
                </td>
            </tr>
            <br/>
