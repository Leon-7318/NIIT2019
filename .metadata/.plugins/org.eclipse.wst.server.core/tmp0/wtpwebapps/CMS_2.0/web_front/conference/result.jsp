        ...
        <td>
            <div class="entity_wrapper">
                <div class="entity_title">   
                    <h1><a href="${pageContext.request.contextPath}/conf/showConference?id=${conf.getRes(i).id}">${conf.getRes(i).name}</a></h1>
                </div>
                <div class="entity_thumb">
                    <a href="${pageContext.request.contextPath}/conf/showConference?id=${conf.getRes(i).id}">
                        <img class="img-responsive" src="${conf.getRes(i).poster}" width="400" height="250" alt="feature-top"/>
                    </a>
                </div>
                <div class="entity_content">
                    <a href="${pageContext.request.contextPath}/conf/showConference?id=${conf.getRes(i).id}"><p>${conf.getRes(i).sketch}</p></a>
                </div>
                <div class="entity_meta">${conf.getRes(i).date} , by: ${conf.getRes(i).author}</div>
            </div>
        </td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td>
            <div class="entity_wrapper">
                  <div class="entity_title">
                    <h1><a href="${pageContext.request.contextPath}/conf/showConference?id=${conf.getRes(i+1).id}">${conf.getRes(i+1).name}</a></h1>
                </div>
                <div class="entity_thumb">
                    <a href="${pageContext.request.contextPath}/conf/showConference?id=${conf.getRes(i+1).id}">
                        <img class="img-responsive" src="${conf.getRes(i+1).poster}" width="400" height="250" alt="feature-top"/>
                    </a>
                </div>
                <div class="entity_content">
                    <a href="${pageContext.request.contextPath}/conf/showConference?id=${conf.getRes(i+1).id}"><p>${conf.getRes(i+1).sketch}</p></a>
                </div>
                <div class="entity_meta">${conf.getRes(i+1).date} , by: ${conf.getRes(i+1).author}</div>
            </div>
        </td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td>
            <div class="entity_wrapper">
                <div class="entity_title">
                  <h1><a href="${pageContext.request.contextPath}/conf/showConference?id=${conf.getRes(i+2).id}">${conf.getRes(i+2).name}</a></h1>
                </div>
                <div class="entity_thumb">
                    <a href="${pageContext.request.contextPath}/conf/showConference?id=${conf.getRes(i+2).id}">
                        <img class="img-responsive" src="${conf.getRes(i+2).poster}" width="400" height="250" alt="feature-top"/>
                    </a>
                </div>
                <div class="entity_content">
                    <a href="${pageContext.request.contextPath}/conf/showConference?id=${conf.getRes(i+2).id}"><p>${conf.getRes(i+2).sketch}</p></a>
                </div>
                <div class="entity_meta">${conf.getRes(i+2).date} , by: ${conf.getRes(i+2).author}</div>
            </div>
        </td>
    </tr>
    <br/>
