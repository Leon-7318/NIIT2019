...
<div class="col-md-8">
    <div class="entity_wrapper">
        ...
        <!-- entity_title -->
        <div class="entity_meta">${conf.temp_Conference.date} , by: ${conf.temp_Conference.author}</div>
        <!-- entity_meta -->
        <div class="rating">
        ...
        <div class="entity_thumb">
            <img class="img-responsive" src="${conf.temp_Conference.poster}" alt="feature-top"/>
        </div>
