...
<div class="row">
<div class="col-md-8">
    <c:forEach var="i" begin="0" end="${news.num-1}" step="1">
        <div class="entity_wrapper">
            <div class="entity_title">
                <h1><a href="${pageContext.request.contextPath}/news/showNews?id=${news.getNow(i).id}">${news.getNow(i).title}</a></h1>
            </div>
            <!-- entity_title -->
            <div class="entity_meta">${news.getNow(i).date} , by: ${news.getNow(i).author}</div>
            <!-- entity_meta -->
            <div class="rating">s
            ...
            <div class="entity_thumb">
                <a href="${pageContext.request.contextPath}/news/showNews?id=${news.getNow(i).id}">
                    <img class="img-responsive" src="${news.getNow(i).image}" alt="feature-top"/>
                </a>
            </div>
            <div class="entity_content">
                <a href="${pageContext.request.contextPath}/news/showNews?id=${news.getNow(i).id}"><p>${news.getNow(i).sketch}</p></a>
            </div>
        </div>
        <br/>
    </c:forEach>
    <nav aria-label="Page navigation" class="pagination_section">
        <ul class="pagination">
            <a href="${pageContext.request.contextPath}/news/previous"><button aria-label="Previous">上一页</button></a>&nbsp;
            <c:forEach var="i" begin="1" end="${news.page_num}">
                <a href="${pageContext.request.contextPath}/news/jumpTo?id=${i}"><button>${i}</button></a>&nbsp;
            </c:forEach>
            <a href="${pageContext.request.contextPath}/news/next"><button aria-label="Next" class="active">下一页v</button></a>
        </ul>
    </nav>
    <!-- navigation -->
</div>
            ...
            <c:forEach var="i" begin="0" end="3">
                <div class="media">
                    <div class="media-left">
                        <a href="${pageContext.request.contextPath}/product/showProduct?id=${product.getNow(i).id}" target="_self">
