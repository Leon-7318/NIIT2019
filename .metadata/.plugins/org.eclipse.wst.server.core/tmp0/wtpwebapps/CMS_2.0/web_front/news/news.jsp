...
<div class="col-md-8">
    <div class="entity_wrapper">
        <div class="entity_title">
            <h1>${news.temp_New.title}</h1>
        </div>
        <!-- entity_title -->
        <div class="entity_meta">${news.temp_New.date} , by: ${news.temp_New.author}</div>
        <!-- entity_meta -->
        <div class="rating">
        ...
        <div class="entity_thumb">
            <img class="img-responsive" src="${news.temp_New.image}" alt="feature-top"/>
        </div>
        <div class="entity_content">
            <p>${news.temp_New.detail}</p>
        </div>
    </div>
    <br/>
</div>
