...
<body class="childrenBody">
    <blockquote class="layui-elem-quote news_search">
		<div class="layui-inline">
             <form action="${pageContext.request.contextPath}/video/searchByKey" method="post">
		...
		<div class="layui-inline">
             <a href="${pageContext.request.contextPath}/video/add_Video" class="layui-btn layui-btn-normal newsAdd_btn">添加视频</a>
		</div>
		<div class="layui-inline">
    ...
    <form id="videoContent" class="layui-form">
	      ...
	      <c:forEach items="${video.now}" var="v">
			  <tr>
			    <th><input type="checkbox" lay-skin="primary" lay-filter="allChoose"/></th>
			    <th>${v.title}</th>
			    <th width="200">
			    ...
			    <th width="100">
	               	<select id="${v.id}" onchange="javascript:{
    ...
    <div class="layui-inline" style="float:right">
          <a href="${pageContext.request.contextPath}/video/previous" class="layui-btn layui-btn-small " style="background-color:#5FB878">上一页</a>
          <c:forEach var="i" begin="1" end="${video.page_num}">
              <a href="${pageContext.request.contextPath}/video/jumpTo?id=${i}" class="layui-btn layui-btn-small layui-btn-primary"  >${i}</a> 
          </c:forEach>
          <a href="${pageContext.request.contextPath}/video/next" class="layui-btn layui-btn-small " style="background-color:#5FB878">下一页</a>
  			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</div>
