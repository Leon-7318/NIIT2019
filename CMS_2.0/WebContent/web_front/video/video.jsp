...
<%--* 搜索框 --%>
                                   	<form href="${pageContext.request.contextPath}/conf/searchByKey" method="post" >
...
<div class="col-md-8">
    <div class="entity_wrapper">
        ...
        <div class="entity_thumb">
            <video src="${video.temp_Video.url}" alt="暂时无法播放" width="750" height="450" controls="controls"></video>
        </div>
        <div class="entity_content">${video.temp_Video.sketch}</div>
        <div class="entity_meta">${video.temp_Video.date}, by: ${video.temp_Video.author}</div>
            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <div class="widget_article_social">
                        <span><a href="single.html" target="_self"> <i class="fa fa-share-alt"></i>424</a> Shares</span> 
                        <span><a href="single.html" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments</span>
                    </div>
                </div>
            </div>
        </c:forEach>
