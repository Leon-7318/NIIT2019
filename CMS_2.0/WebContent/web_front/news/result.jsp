...
<div class="row">
        <table>
        <c:forEach var="i" begin="0" end="${news.res.size()-1}" step="3">
            <tr>
                <td>
                    <div class="entity_wrapper">
                        <div class="entity_title">
                            <h1><a href="${pageContext.request.contextPath}/news/showNews?id=${news.getRes(i).id}">${news.getRes(i).title}</a></h1>
                        </div>
                        <div class="entity_thumb">
                            <a href="${pageContext.request.contextPath}/news/showNews?id=${news.getRes(i).id}">
                                <img class="img-responsive" src="${news.getRes(i).image}" width="400" height="250" alt="feature-top"/>
                            </a>
                        </div>
                        <div class="entity_content">
                            <a href="${pageContext.request.contextPath}/news/showNews?id=${news.getRes(i).id}"><p>${news.getRes(i).sketch}</p></a>
                        </div>
                        <div class="entity_meta">${news.getRes(i).date} , by: ${news.getRes(i).author}</div>
                    </div>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
                    <div class="entity_wrapper">
                          <div class="entity_title">
                            <h1><a href="${pageContext.request.contextPath}/news/showNews?id=${news.getRes(i+1).id}">${news.getRes(i+1).title}</a></h1>
                        </div>
                        <div class="entity_thumb">
                            <a href="${pageContext.request.contextPath}/news/showNews?id=${news.getRes(i+1).id}">
                                <img class="img-responsive" src="${news.getRes(i+1).image}" width="400" height="250" alt="feature-top"/>
                            </a>
                        </div>
                        <div class="entity_content">
                            <a href="${pageContext.request.contextPath}/news/showNews?id=${news.getRes(i+1).id}"><p>${news.getRes(i+1).sketch}</p></a>
                        </div>
                        <div class="entity_meta">${news.getRes(i+1).date} , by: ${news.getRes(i+1).author}</div>
                    </div>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
                    <div class="entity_wrapper">
                          <div class="entity_title">
                            <h1><a href="${pageContext.request.contextPath}/news/showNews?id=${news.getRes(i+2).id}">${news.getRes(i+2).title}</a></h1>
                        </div>
                        <div class="entity_thumb">
                            <a href="${pageContext.request.contextPath}/news/showNews?id=${news.getRes(i+2).id}">
                                <img class="img-responsive" src="${news.getRes(i+2).image}" width="400" height="250" alt="feature-top"/>
                            </a>
                        </div>
                        <div class="entity_content">
                            <a href="${pageContext.request.contextPath}/news/showNews?id=${news.getRes(i+2).id}"><p>${news.getRes(i+2).sketch}</p></a>
                        </div>
                        <div class="entity_meta">${news.getRes(i+2).date} , by: ${news.getRes(i+2).author}</div>
                    </div>
                </td>
            </tr>
            <br/>
